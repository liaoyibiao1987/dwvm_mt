...
public class s_loginDDNS {
    ...
    private byte[] szUsernameEncrypt = new byte[s_messageBase.WVM_MAX_USERNAME_LEN];
    ...
    private byte[] szPasswordEncrypt = new byte[s_messageBase.WVM_MAX_PASSWORD_LEN];
    ...
    private byte[] szTelphoneZone = new byte[s_messageBase.WVM_MAX_TELPHONE_CODE_LEN];
    ...
    @StructField(order = 5)
    @ForceLength(forceLen = s_messageBase.WVM_MAX_TELPHONE_CODE_LEN)
    private byte[] szTelphoneCode = new byte[s_messageBase.WVM_MAX_TELPHONE_CODE_LEN];
    ...
    private byte[] szDeviceVersion = new byte[s_messageBase.WVM_MAX_DEVICE_VERSION_LEN];
    ...
    private byte[] szDeviceName = new byte[s_messageBase.WVM_MAX_DEVICE_NAME_LEN];

    /// <summary>
    /// 编码通道数量。仅对MT,MP,LSS有效
    /// </summary>
    @StructField(order = 8)
    private int dwEncoderChannelNumber;

    /// <summary>
    /// 解码通道数量。仅对MT,MP,LSS有效
    /// </summary>
    @StructField(order = 9)
    private int dwDecoderChannelNumber;
