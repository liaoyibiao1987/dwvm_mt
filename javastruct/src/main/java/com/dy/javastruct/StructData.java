...
public class StructData {
    ...
    HashMap<String, Field> forceLenArrayFields = new HashMap<String, Field>();
    ...
    public StructData(Field[] fields, Method[] methods) throws StructException {
        ...
        for (Field field : fields) {
            ...
            // find the members whose length are force.
            ForceLength forceLengthMarker = field.getAnnotation(ForceLength.class);
            if (forceLengthMarker != null) {
                fieldData.setForceLength(forceLengthMarker.forceLen());
                forceLenArrayFields.put(field.getName(), field);
            }
